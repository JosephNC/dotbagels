                ...
                <div class="md:flex md:flex-shrink-0">
                    <div class="bg-primary-900 md:flex-shrink-0 md:w-56 px-6 py-4 flex items-center justify-between md:justify-center">
                        ...
                        <dropdown class="md:hidden" placement="bottom-end">
                            ...
                            <div slot="dropdown" class="mt-2 px-8 py-4 shadow-lg bg-primary-800 rounded">
                                <main-menu />
                            </div>
                        </dropdown>
                    </div>
                    ...
                    <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-md flex justify-between items-center">
                        ...
                        <dropdown class="mt-1" placement="bottom-end">
                            ...
                            <div slot="dropdown" class="mt-2 py-2 shadow-xl bg-white rounded text-sm">
                                <inertia-link class="block px-6 py-2 hover:bg-primary-500 hover:text-white" :href="route('users.edit', $page.props.auth.user.id)">My Profile</inertia-link>
                                <inertia-link class="block px-6 py-2 hover:bg-primary-500 hover:text-white" :href="route('users')">Manage Users</inertia-link>
                                <inertia-link class="block px-6 py-2 hover:bg-primary-500 hover:text-white w-full text-left" :href="route('logout')" method="post" as="button">Logout</inertia-link>
                            </div>
                        </dropdown>
                    </div>
                </div>
                <div class="md:flex md:flex-grow md:overflow-hidden">
                    <main-menu class="hidden md:block bg-primary-800 flex-shrink-0 w-56 p-12 overflow-y-auto" />
