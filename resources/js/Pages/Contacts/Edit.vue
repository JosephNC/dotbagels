<template>
    <div>
        <h1 class="mb-8 font-bold text-3xl">
            <inertia-link class="text-primary-400 hover:text-primary-600" :href="route('contacts')">Contacts</inertia-link>
        ...
        <div class="bg-white rounded-md shadow overflow-hidden max-w-3xl">
            <form @submit.prevent="update">
                ...
                <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex items-center">
                    ...
                    <loading-button :loading="form.processing" class="btn btn-primary ml-auto" type="submit">Update Contact</loading-button>
                </div>
            </form>
        </div>
    </div>
