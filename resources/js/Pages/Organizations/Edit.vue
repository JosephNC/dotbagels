<template>
    <div>
        <h1 class="mb-8 font-bold text-3xl">
            <inertia-link class="text-primary-400 hover:text-primary-600" :href="route('organizations')">Organizations</inertia-link>
        ...
        <div class="bg-white rounded-md shadow overflow-hidden max-w-3xl">
            <form @submit.prevent="update">
                ...
                <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex items-center">
                    ...
                    <loading-button :loading="form.processing" class="btn btn-primary ml-auto" type="submit">Update Organization</loading-button>
                </div>
            </form>
        </div>
        ...
        <div class="mt-6 bg-white rounded shadow overflow-x-auto">
            <table class="w-full whitespace-nowrap">
                ...
                <tr v-for="contact in organization.contacts" :key="contact.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                    <td class="border-t">
                        <inertia-link class="px-6 py-4 flex items-center focus:text-primary-500" :href="route('contacts.edit', contact.id)">
                            {{ contact.name }}
