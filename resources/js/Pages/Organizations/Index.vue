<template>
  <div>
    ...
    <div class="mb-6 flex justify-between items-center">
      ...
      <inertia-link class="btn btn-primary" :href="route('organizations.create')">
        <span>Create</span>
    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="organization in organizations.data" :key="organization.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
            <inertia-link class="px-6 py-4 flex items-center focus:text-primary-500" :href="route('organizations.edit', organization.id)">
              {{ organization.name }}
