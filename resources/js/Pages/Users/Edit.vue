        ...
        <div class="bg-white rounded-md shadow overflow-hidden max-w-3xl">
            <form @submit.prevent="update">
                <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
                    ...
                    <!-- <text-input v-model="form.phone" :error="form.errors.phone" class="pr-6 pb-8 w-full lg:w-1/2" type="tel" autocomplete="phone" label="Phone Number" /> -->
                    <phone-input v-model="form.phone" :error="form.errors.phone" class="pr-6 pb-8 w-full lg:w-1/2" autocapitalize="off" label="Phone Number" @countryCode="phoneCountryCode" />
...
export default {
    ...
    methods: {
        update() {
            this.form.post(this.route('users.update', this.$page.props.auth.user.id), {
